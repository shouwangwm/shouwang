 ...
 *
 * 11/05/02 -- Performance enhancement from Mike Dubman. Moved InetAddr.getLocal to static block.
 * Mike has measured a 10 fold improvement in run time. 01/29/02 -- Bug fix: Improper seeding of
 * nonsecure Random object caused duplicate GUIDs to be produced. Random object is now only created
 * once per JVM. 01/19/02 -- Modified random seeding and added new constructor to allow secure
 * random feature. 01/14/02 -- Added random function seeding with JVM run time
 *
 */
 ...
 * inspection and modification. This class is free for all uses.
 *
 *
 * - Marc
 */
...
public class RandomGUID extends Object {
   ...
   * be cryptographically strong. Secure false defaults to the standard Random function seeded with
   * a single cryptographically strong random number.
   */
