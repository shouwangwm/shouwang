...
<html>
  ...
  <body>
    findAll方法测试：
  	<form action="other/findAll" method="post">
    ...
    add方法测试：
    <form action="other/add" method="post">
	    <table>
	    	<tr>
	    		<td>主键id：</td>
	    	...
	    	<tr>
	    		<td>性别：</td>
	    		<td><input id="sex" name="sex" type="text" maxlength="2"></td>
	    	</tr>
	    </table>
    ...
    <form action="other/update" method="post">
    	<table>
	    	<tr>
	    		<td>主键id：</td>
